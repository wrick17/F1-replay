...
<html lang="en">
  <head>
    ...
    <title>Car Telemetry Cache Warmer</title>
    <style>
      ...
      .bar > div { height: 100%; background: linear-gradient(90deg, #1a73e8, #34a853, #fbbc05, #ea4335); width: 0%; transition: width 0.4s ease; }
  ...
  <body>
    <header><h1>Car Telemetry Cache Warmer</h1></header>
    <main>
      <section class="card">
        <div class="metrics">
