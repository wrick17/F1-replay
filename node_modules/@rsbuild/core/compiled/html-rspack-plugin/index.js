(() => {
  var __webpack_modules__ = {
    506: (module, __unused_webpack_exports, __nccwpck_require__) => {
      "use strict";
      const { HtmlWebpackChildCompiler } = __nccwpck_require__(635);
    ...
    551: (module, __unused_webpack_exports, __nccwpck_require__) => {
      ...
      const { CachedChildCompilation } = __nccwpck_require__(506);
      const { createHtmlTagObject, htmlTagObjectToString, HtmlTagArray } =
        __nccwpck_require__(30);
      const prettyError = __nccwpck_require__(768);
      const chunkSorter = __nccwpck_require__(689);
      const getHtmlRspackPluginHooks =
        __nccwpck_require__(847).getHtmlRspackPluginHooks;
