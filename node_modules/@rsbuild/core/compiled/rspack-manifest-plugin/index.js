(() => {
  ...
  var __webpack_modules__ = {
    189: (__unused_webpack_module, exports, __nccwpck_require__) => {
      ...
      const reduceAssets = (files, asset, moduleAssets) => {
        ...
        if (moduleAssets[asset.name]) {
          ...
          name = (0, node_path_1.join)(
            (0, node_path_1.dirname)(asset.name),
            (0, node_path_1.basename)(asset.info.sourceFilename),
          );
        }
        if (name) {
          return files.concat({
    ...
    632: (__unused_webpack_module, exports, __nccwpck_require__) => {
      Object.defineProperty(exports, "__esModule", { value: true });
      ...
      const helpers_1 = __nccwpck_require__(189);
      ...
      const emitHook = function emit(
        ...
        const integrityMap = {};
        (_a = stats.assets) === null || _a === void 0
          ? void 0
          : _a.forEach((asset) => {
              if (asset.integrity) {
        ...
        if (isLastEmit) {
          ...
          if (options.writeToFileEmit) {
            (0, node_fs_1.mkdirSync)(
              (0, node_path_1.dirname)(manifestFileName),
              { recursive: true },
            );
        ...
        loaderContext.emitFile = (file, content, sourceMap) => {
          if (module.userRequest && !moduleAssets[file]) {
            Object.assign(moduleAssets, {
              [file]: (0, node_path_1.join)(
                (0, node_path_1.dirname)(file),
                (0, node_path_1.basename)(module.userRequest),
              ),
            });
          }
  ...
  (() => {
    ...
    exports.RspackManifestPlugin =
      ...
      exports.getCompilerHooks =
        void 0;
    const node_path_1 = __nccwpck_require__(760);
    const hooks_1 = __nccwpck_require__(632);
    ...
    class WebpackManifestPlugin {
      ...
      apply(compiler) {
        var _a, _b;
        const moduleAssets = {};
        const manifestFileName = (0, node_path_1.resolve)(
          ((_a = compiler.options.output) === null || _a === void 0
            ? void 0
            : _a.path) || "./",
          this.options.fileName,
        );
        const manifestAssetId = (0, node_path_1.relative)(
