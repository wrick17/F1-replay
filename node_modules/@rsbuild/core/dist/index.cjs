...
var __webpack_modules__ = {
    ...
    "../../node_modules/.pnpm/javascript-stringify@2.1.0/node_modules/javascript-stringify/dist/array.js" (__unused_rspack_module, exports1) {
        "use strict";
    ...
    "../../node_modules/.pnpm/javascript-stringify@2.1.0/node_modules/javascript-stringify/dist/function.js" (__unused_rspack_module, exports1, __webpack_require__) {
        "use strict";
        Object.defineProperty(exports1, "__esModule", {
            value: !0
    ...
    "../../node_modules/.pnpm/javascript-stringify@2.1.0/node_modules/javascript-stringify/dist/index.js" (__unused_rspack_module, exports1, __webpack_require__) {
        "use strict";
    ...
    "../../node_modules/.pnpm/javascript-stringify@2.1.0/node_modules/javascript-stringify/dist/object.js" (__unused_rspack_module, exports1, __webpack_require__) {
        "use strict";
        Object.defineProperty(exports1, "__esModule", {
            value: !0
    ...
    "../../node_modules/.pnpm/javascript-stringify@2.1.0/node_modules/javascript-stringify/dist/quote.js" (__unused_rspack_module, exports1) {
        "use strict";
        Object.defineProperty(exports1, "__esModule", {
            value: !0
    ...
    "../../node_modules/.pnpm/javascript-stringify@2.1.0/node_modules/javascript-stringify/dist/stringify.js" (__unused_rspack_module, exports1, __webpack_require__) {
        "use strict";
        Object.defineProperty(exports1, "__esModule", {
            value: !0
...
`)
    ...
    async function printFileSizes(options, stats, rootPath, distPath, environmentName, previousSizes) {
        ...
        let relativeDistPath = external_node_path_default().relative(rootPath, distPath), snapshot = {
            ...
            var assetName;
            let assetName1, { size, filePath } = asset, gzippedSize = options.compressed && (assetName1 = filePath, COMPRESSIBLE_REGEX.test(assetName1)) ? await gzipSize(asset.content) : null, normalizedPath = normalizeFilePath(filePath);
            ...
            let folder = external_node_path_default().join(relativeDistPath, external_node_path_default().dirname(filePath)), filename = external_node_path_default().basename(filePath), filenameLabel = color.dim(folder + external_node_path_default().sep) + (assetName = filename, JS_REGEX.test(assetName) ? color.cyan(assetName) : assetName.endsWith('.css') ? color.yellow(assetName) : assetName.endsWith('.html') ? color.green(assetName) : color.magenta(assetName)), filenameLength = (folder + external_node_path_default().sep + filename).length;
            return {
                filePath,
                filename,
                filenameLabel,
            ...
            let assets = Object.entries(stats.compilation.assets).map(([assetName, value])=>{
                ...
                try {
                    ...
                    content = external_node_fs_default().readFileSync(external_node_path_default().join(distPath, filePath));
                }
                return {
                    filePath,
...
`;
    ...
    function setupCommands() {
        ...
        cli.version("1.7.3"), cli.option('--base <base>', 'Set the base path of the server').option('-c, --config <config>', 'Set the configuration file (relative or absolute path)').option('--config-loader <loader>', 'Set the config file loader (auto | jiti | native)', {
            default: 'auto'
